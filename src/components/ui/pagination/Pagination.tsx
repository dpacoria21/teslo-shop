                            ...
                            <li key={i} className="page-item"><Link
                                className={
                                    clsx(
                                        ...
                                        {
                                            'bg-blue-600 text-slate-50': num === currentPage,
                                            'bg-transparent text-gray-800 hover:bg-gray-200 hover:text-gray-800': num !== currentPage
                                        }
                                    )
                                }
                                href={createPageUrl(num)}>{num}</Link></li>
                        ))
                    }
